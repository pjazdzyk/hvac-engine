...
public class CoolingFromTemperatureBlock implements ProcessBlock {
    ...
    public CoolingFromTemperatureBlock(InputConnector<FlowOfHumidAir> inputAirFlowConnector,
    ...
    public static CoolingFromTemperatureBlock of(FlowOfHumidAir inletAirFlow,
        ...
        return new CoolingFromTemperatureBlock(
    ...
    public static CoolingFromTemperatureBlock of(InputConnector<FlowOfHumidAir> inletAirFlow,
        ...
        return new CoolingFromTemperatureBlock(inletAirFlow, coolantData, targetTemperature);
    }

    public static CoolingFromTemperatureBlock of(CoolantData coolantData,
                                                 Temperature targetTemperature) {

...
import com.synerset.hvaclib.fluids.*;
import com.synerset.hvaclib.process.*;
...
public class Examples {
    ...
    public static void runUserGuideExamples() {
        ...
        HumidGas summerAir = new HumidAirOld(30, 45, 90000, HumidAirOld.HumidityInputType.RELATIVE_HUMIDITY);

        // Using Builder Pattern
        HumidGas summerAirBld = new HumidAirOld.Builder()
                .withAirTemperature(30)
                .withRelativeHumidity(45)
                .build();

        // Static factory methods
        HumidGas exampleAir1 = HumidAirOld.ofAir(30, 45);
        HumidGas exampleAir2 = HumidAirOld.ofAir(30, 45, 90000);
        ...
        HumidGas airExample = new HumidAirOld.Builder()
        ...
        HumidGas winterAmbientAir = HumidAirOld.ofAir(-20, 99, 101_325);
        ...
        // Step 1: Creating moist air instance
        HumidGas summerAmbientAir = HumidAirOld.ofAir(32, 50, 90000);
        // Step 3: creating humid air flow
        ...
        HumidGas coldAmbientAir = HumidAirOld.ofAir(-20, 99, 101_325);
        ...
        HumidGas returnAir1 = HumidAirOld.ofAir(20, 30, 101_325);
        FlowOfHumidGas returnFlow1 = FlowOfMoistAir.ofM3hVolFlow(returnAir1, 5000);
        HumidGas returnAir2 = HumidAirOld.ofAir(15, 45, 101_325);
        FlowOfHumidGas returnFlow2 = FlowOfMoistAir.ofM3hVolFlow(returnAir2, 2000);
        HumidGas returnAir3 = HumidAirOld.ofAir(18, 30, 101_325);

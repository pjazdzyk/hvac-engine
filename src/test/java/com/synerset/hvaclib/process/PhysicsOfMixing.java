...
public final class PhysicsOfMixing {
     ...
     */
    public static MixingResultDto mixTwoHumidGasFlows(HumidAir inFirstAir, double firstInDryAirFlow, HumidAir inSecondAir, double secondInDryAirFlow) {
    ...
    public static MixingResultDto mixTwoHumidGasFlows(FlowOfHumidAir firstFlow, FlowOfHumidAir secondFlow) {
    ...
    public static MixingResultDto mixTwoHumidGasFlowsForTargetOutFlowAndTemp(MixingInputDataDto mixingInputFlows) {
        FlowOfHumidAir inletFlow = mixingInputFlows.getInletFlow();
        FlowOfHumidAir recirculationFlow = mixingInputFlows.getRecirculationFlow();
     ...
     */
    public static BasicResults mixMultipleHumidGasFlows(FlowOfHumidAir inletFlow, FlowOfHumidAir... recirculationFlows) {
        ProcessValidators.requireArrayNotContainsNull("Recirculation flows", recirculationFlows);
        HumidAir inletAir = inletFlow.getFluid();
        ...
        for (FlowOldOfHumidGas flow : recirculationFlows) {
    ...
    public static MixingResultDto calcMixingFromOutTxOutMda(MixingInputDataDto mixingInputFlows, double targetOutDryMassFlow, double targetOutTemp) {
        ...
        HumidAir air1 = inletFlow.getFluid();
        HumidAir air2 = recirculationFlow.getFluid();
